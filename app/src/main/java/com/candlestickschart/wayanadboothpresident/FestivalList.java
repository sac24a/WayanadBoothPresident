...
import com.candlestickschart.wayanadboothpresident.databinding.ActivityFestivalListBinding;
...
public class FestivalList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ActivityFestivalListBinding searchVoterBinding = DataBindingUtil.setContentView(this,R.layout.activity_festival_list);
        ...
        addNew.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(FestivalList.this, AddFestival.class);
    ...
    protected void onPostResume() {
        ...
        AppExecutors.getInstance().diskIO().execute(new Runnable() {
            @Override
            public void run() {
                PollFirstDataBase pollFirstDataBase = PollFirstDataBase.getInstance(FestivalList.this);
                impPersonName = pollFirstDataBase.pollFirstDao().getFestivalName();
                    ...
                    AppExecutors.getInstance().mainThread().execute(new Runnable() {
                        ...
                        public void run() {
                            ArrayAdapter<String> itemsAdapter =
                                    new ArrayAdapter<String>(FestivalList.this, android.R.layout.simple_list_item_1, impPersonName);
                            listView.setAdapter(itemsAdapter);
//                            listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
//                                @Override
//                                public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
//                                    Intent intent = new Intent(FestivalList.this, BoothAgentAc.class);
