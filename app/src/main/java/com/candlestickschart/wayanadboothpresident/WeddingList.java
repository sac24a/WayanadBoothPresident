...
import com.candlestickschart.wayanadboothpresident.databinding.ActivityWeddingListBinding;
...
public class WeddingList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ActivityWeddingListBinding searchVoterBinding = DataBindingUtil.setContentView(this,R.layout.activity_wedding_list);
        ...
        addNew.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(WeddingList.this, AddWedding.class);
    ...
    protected void onPostResume() {
        ...
        AppExecutors.getInstance().diskIO().execute(new Runnable() {
            @Override
            public void run() {
                PollFirstDataBase pollFirstDataBase = PollFirstDataBase.getInstance(WeddingList.this);
                impPersonName = pollFirstDataBase.pollFirstDao().getWeddingName();
                    ...
                    AppExecutors.getInstance().mainThread().execute(new Runnable() {
                        ...
                        public void run() {
                            ArrayAdapter<String> itemsAdapter =
                                    new ArrayAdapter<String>(WeddingList.this, android.R.layout.simple_list_item_1, impPersonName);
                            listView.setAdapter(itemsAdapter);
//                            listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
//                                @Override
//                                public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
//                                    Intent intent = new Intent(WeddingList.this, BoothAgentAc.class);
