...
import com.candlestickschart.wayanadboothpresident.databinding.ActivityDeathListBinding;

import java.util.ArrayList;
import java.util.List;

public class DeathList extends AppCompatActivity {
    ListView listView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ActivityDeathListBinding searchVoterBinding = DataBindingUtil.setContentView(this,R.layout.activity_death_list);
        ...
        addNew.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(DeathList.this, AddDeath.class);
    ...
    protected void onPostResume() {
        ...
        AppExecutors.getInstance().diskIO().execute(new Runnable() {
            @Override
            public void run() {
                PollFirstDataBase pollFirstDataBase = PollFirstDataBase.getInstance(DeathList.this);
                impPersonName = pollFirstDataBase.pollFirstDao().getDeathName();
                    ...
                    AppExecutors.getInstance().mainThread().execute(new Runnable() {
                        ...
                        public void run() {
                            ArrayAdapter<String> itemsAdapter =
                                    new ArrayAdapter<String>(DeathList.this, android.R.layout.simple_list_item_1, impPersonName);
                            listView.setAdapter(itemsAdapter);
//                            listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
//                                @Override
//                                public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
//                                    Intent intent = new Intent(DeathList.this, BoothAgentAc.class);
