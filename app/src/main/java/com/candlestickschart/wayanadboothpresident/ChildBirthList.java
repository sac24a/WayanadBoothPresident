...
import com.candlestickschart.wayanadboothpresident.databinding.ActivityChildBirthListBinding;

import java.util.ArrayList;
import java.util.List;

public class ChildBirthList extends AppCompatActivity {
    ListView listView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_child_birth_list);
        sharedPreferences = getSharedPreferences("login",MODE_PRIVATE);
        ActivityChildBirthListBinding searchVoterBinding = DataBindingUtil.setContentView(this,R.layout.activity_child_birth_list);
        ...
        addNew.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(ChildBirthList.this, AddChildBirth.class);
    ...
    protected void onPostResume() {
        ...
        AppExecutors.getInstance().diskIO().execute(new Runnable() {
            @Override
            public void run() {
                PollFirstDataBase pollFirstDataBase = PollFirstDataBase.getInstance(ChildBirthList.this);
                impPersonName = pollFirstDataBase.pollFirstDao().getChildBrithName();
                    ...
                    AppExecutors.getInstance().mainThread().execute(new Runnable() {
                        ...
                        public void run() {
                            ArrayAdapter<String> itemsAdapter =
                                    new ArrayAdapter<String>(ChildBirthList.this, android.R.layout.simple_list_item_1, impPersonName);
                            listView.setAdapter(itemsAdapter);
//                            listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
//                                @Override
//                                public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
//                                    Intent intent = new Intent(ChildBirthList.this, BoothAgentAc.class);
